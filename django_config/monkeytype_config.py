...
from typeline.cli import generate_stub_for_module
from typeline.postgres.config import PostgresConfig
from typeline.rewriters.transformers import simplify_types, simplify_int_float, FindAcceptableCommonBase, \
    remove_empty_container, DepthFirstTypeTraverser, TwoElementUnionRewriter, SimplifyGenerics
from typeline.typing import ChainedRewriter, RewriteLargeUnion
...
def get_path_to_stubfile(module, output_dir):
    ...
    if is_package(module):
        ...
        path_to_stub_file = path_to_stub_file.with_suffix('.pyi')
