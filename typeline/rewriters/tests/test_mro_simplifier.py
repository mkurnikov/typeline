...
from typeline.rewriters.tests.module1 import A1, B1
from typeline.rewriters.tests.module2 import A2, D2
from typeline.rewriters.tests.test_generics import BaseRewriterTestCase
from typeline.rewriters.transformers import MroSimplifier
